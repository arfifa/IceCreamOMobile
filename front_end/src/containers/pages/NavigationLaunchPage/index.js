      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.containerContent}>
            ...
            <TouchableOpacity style={styles.btnCreateAccount} onPress={() => this.props.navigation.navigate('Register')}><Text style={styles.textBtnCreateAccount}>Create Account</Text></TouchableOpacity>
